    ...
    <div class="row">
      ...
      <div class="col-lg-6 col-md-6 col-sm-6">
        <form action="/registrate" method="post" class="form-new-user">
          ...
          <label>Salt</label>
          <input name="salt" type="text" value="" placeholder="not required field" required="" class="form-control input-xlarge"/>
          <label>Iterations</label>
          <input name="iterations" type="text" value="" maxlength="3" placeholder="not required field; max value = 100" required="" class="form-control input-xlarge"/>
