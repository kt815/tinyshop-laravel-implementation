  ...
  <div class="container">
    ...
    <div id="responsive-menu" class="collapse navbar-collapse">
      <ul class="nav navbar-nav navigation navmenu">
        ...
        <li class="dropdown"><a href="/catalog" data-toggle="dropdown" class="dropdown-toggle">Catalog <b class="caret"></b></a>
          <ul class="dropdown-menu">
            <li><a href="/catalog/smartphones">smartphones</a></li>
      ...
      <ul class="nav navbar-nav navbar-right navigation">
        <li class="dropdown"><a href="/logreg" data-toggle="dropdown" class="dropdown-toggle"><i class="fa fa-sign-in"></i> Login / Registrate</a>
          <ul class="dropdown-menu">
        ...
        <li><a href="/cart" class="cart"><i class="fa fa-shopping-cart"></i> Cart: 0</a></li>
      </ul>
    </div>
  </div>
</div>