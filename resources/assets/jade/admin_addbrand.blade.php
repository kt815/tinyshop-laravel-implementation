  ...
  .container
    .row
      ...
      .col-lg-6.col-md-6.col-sm-6
        form.form-new-brand(name='addbrand', action='/addbrand', method='post')
          label New brand
          input.form-control.input-xlarge(name='brand', type='text', value='', autocomplete='off', required='')
          div
            button.btn.btn-lg.btn-primary.pull-right.btn-adminbar(type='submit') Add brand
| @endsection
