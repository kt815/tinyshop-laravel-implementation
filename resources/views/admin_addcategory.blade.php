  ...
  <div class="container">
    <div class="row">
      ...
      <div class="col-lg-6 col-md-6 col-sm-6">
        <form name="addcategory" action="/addcategory" method="post" class="form-new-category">
          <label>New category</label>
          <input type="hidden" name="_token" value="{{ csrf_token() }}">
          <input name="category" type="text" value="" autocomplete="off" required="" class="form-control input-xlarge"/>
          <div>
            <button type="submit" class="btn btn-lg btn-primary pull-right btn-adminbar">Add category</button>
          </div>
        </form>
      </div>
    </div>
